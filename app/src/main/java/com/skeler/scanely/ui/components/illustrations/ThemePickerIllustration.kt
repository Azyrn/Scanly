...
/**
 * Dynamic color image vectors that adapt to the current theme.
 * Colors are pulled from MaterialTheme.colorScheme for automatic theme adaptation.
 */
object DynamicIllustrations

/**
 * Theme Picker illustration - Undraw style flat vector.
 * Shows a person selecting theme colors, with dynamic coloring.
 * 
 * The illustration uses:
 * - MaterialTheme.colorScheme.primary for accent elements
 * - MaterialTheme.colorScheme.secondary for clothing
 * - MaterialTheme.colorScheme.tertiary for decorative elements
 * - MaterialTheme.colorScheme.onSurface for outlines
 * - Hardcoded skin tones (#ffd1a5) and dark clothing (#2f2e41)
 */
@Composable
fun DynamicIllustrations.themePicker(): ImageVector {
    return Builder(
        name = "themePicker",
